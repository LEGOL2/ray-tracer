...
int main() {
  ...
  auto material_right  = std::make_shared<Metal<double>>(Color(0.8, 0.6, 0.2), 0.0);
  ...
  world.add(std::make_shared<Sphere<double>>(Point3<double>(-1.0,    0.0, -1.0), -0.45, material_left));
  world.add(std::make_shared<Sphere<double>>(Point3<double>( 1.0,    0.0, -1.0),   0.5, material_right));

  // Camera
  Camera camera(Point3<double>(-2.0 , 2.0, 1.0), Point3<double>(0.0, 0.0, -1.0), Vec3<double>(0.0, 1.0, 0.0), 20.0, ASPECT_RATIO);
